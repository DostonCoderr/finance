...
const CurrencyConverter = () => {
  const { exchangeRates, baseCurrency, isLoadingRates, error } = useContext(FinanceContext);
  ...
  const handleConvert = () => {
    ...
    const converted = (amount * (exchangeRates[toCurrency] / exchangeRates[fromCurrency])).toFixed(2);
    ...
    <div className="currency-converter-card">
      ...
      <div className="currency-converter-body">
        ...
        <div className="input-group">
          ...
          <div>
            <label className="form-label">Quyidagidan aylantirish:</label>
            <select
          ...
          <div>
            <label className="form-label">Quyidagiga aylantirish:</label>
            <select
              className="currency-converter-select"
              value={toCurrency}
        ...
        {isLoadingRates && <div className="currency-converter-alert currency-converter-alert-info">Loading exchange rates...</div>}
        {error && <div className="currency-converter-alert currency-converter-alert-danger">{error}</div>}
        {convertedValue && (
